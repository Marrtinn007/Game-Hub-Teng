...
const SPY_LOCATIONS=[
  ...
  {name:'โรงแรม 5 ดาว',e:'🏨',roles:['รปภ.','แขกผู้เข้าพัก','เจ้าของโรงแรม','แม่บ้าน','พ่อครัว','บาร์เทนเดอร์','พนักงานยกกระเป๋า','พนักงานต้อนรับ','ผู้จัดการ','แขกวีไอพี','ช่างซ่อมบำรุง','นักรีวิว']},
  ...
  {name:'งานศพ',e:'⚰️',roles:['พระ','เจ้าภาพงานศพ','ญาติ','เพื่อนสนิท','พิธีกร','ช่างภาพ','สัปเหร่อ','คนดูแลพวงหรีด','คนร้องไห้หนักสุด','แขก','คนกินเลี้ยง','เด็กที่ถูกพามา']},
  ...
  {name:'ร้านซักผ้าหยอดเหรียญ',e:'🧺',roles:['เจ้าของร้าน','ลูกค้าประจำ','ลูกค้าใหม่','นักศึกษา','แม่บ้าน','คนรอผ้าแห้ง','คนพับผ้า','ช่างซ่อมเครื่อง','พนักงานส่งผ้า','คนลืมผ้า','คนย้ายผ้าคนอื่น','แขกขาจร']}
];
