...
const HOME_GAMES_CONFIG=[
  {id:'ww',    label:'🎲 ต้องสร้างห้อง', icon:'🐺', bg:'linear-gradient(135deg,#fb7185,#e11d48)', name:'Werewolf',      desc:'4–18 คน · แจกไพ่บทบาท',     action:"openJoinModal('ww')",    solo:false},
  {id:'spyfall',label:null,               icon:'🕵️', bg:'linear-gradient(135deg,#c084fc,#9333ea)', name:'Spyfall',        desc:'3+ คน · หาสายลับ',           action:"openJoinModal('spyfall')",solo:false},
  {id:'king',   label:null,               icon:'👑', bg:'linear-gradient(135deg,#fbbf24,#f59e0b)', name:"King's Game",    desc:'3+ คน · ราชาสั่ง',           action:"openJoinModal('king')",  solo:false},
  ...
  {id:'wheel',  label:'⚡ เริ่มได้เลย',   icon:'🎰', bg:'linear-gradient(135deg,#4ade80,#16a34a)',name:'Spin the Wheel',  desc:'ตัดสินใจแทนคุณได้เลย',      action:"launchSolo('wheel')",    solo:true},
  {id:'cards',  label:null,               icon:'🃏', bg:'linear-gradient(135deg,#fda4af,#e11d48)',name:'ไพ่ปาร์ตี้',      desc:'ชาเลนจ์สนุกๆ ในวงเพื่อน',  action:"launchSolo('cards')",    solo:true},
];
